# modified to take in sage lfq peptide export and make ready for rank sum by only keeping rows q < 0.01
...
def process_data(input_file, output_file):
    ...
    # Remove rows where 'q_value' column is greater than 0.01
